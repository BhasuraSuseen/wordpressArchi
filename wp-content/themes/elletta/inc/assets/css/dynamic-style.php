...
#sidebar-nav .sidebar-menu li a .indicator, #sidebar-nav .sidebar-menu li a, .main-navigation-wrapper .nav-menu > li > a, .main-navigation-wrapper .top-social-items a, .main-navigation-wrapper .top-search-area a, .main-navigation-wrapper .button-menu-mobile, .sticky-navigation-wrapper .nav-menu > li > a, .sticky-navigation-wrapper .top-social-items a, .sticky-navigation-wrapper .button-menu-mobile, .mobile-search-area a:hover, #mobile-social-items a { color: <?php echo esc_attr($primary_menu_text_color); ?>; }
...
<?php endif; ?>
<?php if ( strcasecmp ($primary_menu_text_color_hover, $elletta_customizer_defaults['primary_menu_text_color_hover']) != 0 ) : ?>
#sidebar-nav .sidebar-menu li a:hover, #sidebar-nav .sidebar-menu li a:hover .indicator, #sidebar-nav .sidebar-menu .sub-menu li a:hover .indicator, .sticky-navigation-wrapper .top-social-items a:hover, .main-navigation .nav-menu > li > a:hover, .main-navigation .nav-menu > li.current_page_item > a, .main-navigation .nav-menu > li.current_page_ancestor > a, .main-navigation .nav-menu > li.current-menu-item > a, .main-navigation .nav-menu > li:hover > a, .main-navigation-wrapper.header-1 .top-social-items a:hover, .main-navigation-wrapper .button-menu-mobile:hover, .mobile-search-area a, #mobile-social-items a:hover { color: <?php echo esc_attr($primary_menu_text_color_hover); ?>; }
...
.box-title-area .title:after, .featured-area[data-slider-type="slider"] .slider-item h2:after, .format-quote .post-entry blockquote p:after, .featured-area[data-slider-type="slider"] .swiper-pagination .swiper-pagination-bullet-active, .featured-area[data-slider-type="slider"] .swiper-pagination .swiper-pagination-bullet:hover, .featured-area .swiper-button-prev-custom:hover, .featured-area .swiper-button-next-custom:hover, .post-header h1:before, .post-header h2:before, .woocommerce span.onsale, h1.tribe-events-single-event-title:after { background: <?php echo esc_attr($link_text_color); ?>; }
